<template>
  <AppLayout>
    <template #header>
      <div data-tour-id="leads-overview" class="flex items-center justify-between w-full">
        <div>
    ...
    <template v-if="viewMode === 'table'">
      ...
      <!-- Tabela de leads -->
      <div v-else data-tour-id="leads-board" class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-[2rem] shadow-[0_4px_20px_rgba(15,23,42,0.06)] overflow-hidden">
    ...
    <template v-else>
      ...
      <div v-else data-tour-id="leads-board" class="flex gap-4 overflow-x-auto pb-4">
        <div
